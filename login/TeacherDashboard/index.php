...
?>
<html>
<title>MFM Learning Teacher Dashboard</title>
...
<div class="w3-container w3-top w3-black w3-large w3-padding" style="z-index:4">
  ...
  <span class="w3-right">MFM Learning</span>
</div>
...
<nav class="w3-sidenav w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidenav"><br>
  <div class="w3-container w3-row">
    ...
    <div class="w3-col s8">
      <span>Welcome, <strong>Mek</strong></span><br>
    ...
    <div class="w3-row-padding" style="margin:0 -16px">
      ...
      <div class="w3-twothird">
        ...
        <table class="w3-table w3-striped w3-white">
          <tr>
            <td><i class="fa fa-file-text-o w3-green w3-padding-tiny"></i></td>
            <td>Example notification.</td>
            <td><i>42069 Years</i></td>
          </tr>
        </table>
      </div>
    </div>
